...
unsigned int nStakeMinAge = 60 * 60 * 8 * 1; // 8 hours
...
const string strMessageMagic = "ThinkAndGrowRich Signed Message:\n";
...
int64_t GetProofOfWorkReward(int64_t nFees)
{
    ...
    if(pindexBest->nHeight > 0 && pindexBest->nHeight < 2800)
    {
        nSubsidy = 10000 * COIN;
    }
    else if(pindexBest->nHeight > 2799 && pindexBest->nHeight < 5600)
    {
        nSubsidy = 5000 * COIN;
    }
    else if(pindexBest->nHeight > 5599 && pindexBest->nHeight < 8400 )
    {
        nSubsidy = 2500 * COIN;
    }
    else if(pindexBest->nHeight > 8399 && pindexBest->nHeight < 10201 )
    {
        nSubsidy = 1250 * COIN;
    }
...
bool CheckDiskSpace(uint64_t nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "ThinkAndGrowRich", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (fTestNet)
    {
        ...
        nStakeMinAge = 9 * 60; // test net min age is 9 min
    ...
    if (mapBlockIndex.empty())
    {
        ...
        const char* pszTimestamp = "ThinkAndGrowRich Coin 2014";
        CTransaction txNew;
        txNew.nTime = 1417474061;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
       ...
       //// debug print
        assert(block.hashMerkleRoot == uint256("0x6752100c5d8f2a5b4a01457ddadd769fc7a05343795e6e2f657f355631416a23"));
        block.print();
...
unsigned char pchMessageStart[4] = { 0xbb, 0x11, 0xcc, 0x3f };
